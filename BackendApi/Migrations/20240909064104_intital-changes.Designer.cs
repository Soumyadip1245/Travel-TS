...
namespace BackendApi.Migrations
{
    ...
    [Migration("20240909064104_intital-changes")]
    partial class intitalchanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendApi.Models.Website", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackendApi.Models.Website", b =>
                {
                    b.HasOne("BackendApi.Models.User", "Supplier")
                        .WithOne("Website")
                        .HasForeignKey("BackendApi.Models.Website", "SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
